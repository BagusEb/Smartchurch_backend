...
class CustomTokenObtainPairSerializer(TokenObtainPairSerializer):
    ...
    def get_token(cls, user):
        ...
        try:
            ...
            # Jika user belum punya profile, default ke admin
            token['role'] = 'admin' 
...
class UserWithProfileSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.first_name = validated_data.get('first_name', instance.first_name) # <-- UPDATE FIRST NAME
        instance.last_name = validated_data.get('last_name', instance.last_name) # <-- UPDATE LAST NAME
